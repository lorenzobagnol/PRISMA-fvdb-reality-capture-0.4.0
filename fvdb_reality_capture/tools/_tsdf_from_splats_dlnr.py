...
class TSDFInputDataset(torch.utils.data.Dataset):
    ...
    def extract_single_tsdf_input(
        ...
        Args:
            ...
            fusion_foreground_mask (torch.Tensor | None): Optional per-view foreground mask with shape
                (1, H, W) or (H, W). Pixels where mask is 0 are removed from TSDF integration.
